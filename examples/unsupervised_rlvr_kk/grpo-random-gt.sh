...
# When RANDOM_GT_MASK_NON_GT=False, non-GT prompts train with majority-vote GT instead of being masked.
export RANDOM_GT_TOP_PCT=${RANDOM_GT_TOP_PCT:-0.2}
export RANDOM_GT_MASK_NON_GT=${RANDOM_GT_MASK_NON_GT:-True}
export REWARD_TYPE=random_gt_zero_adv
PCT_TAG=${RANDOM_GT_TOP_PCT/./p}
MASK_NON_GT_TAG=${RANDOM_GT_MASK_NON_GT}
...
ROLLOUT_DIR=xxx/al-rlvr/logs/phi_${REWARD_TYPE}_top_${PCT_TAG}_mask_non_gt_${MASK_NON_GT_TAG}
...
echo "[random-gt-zero-adv] RANDOM_GT_TOP_PCT=${RANDOM_GT_TOP_PCT}"
echo "[random-gt-zero-adv] RANDOM_GT_MASK_NON_GT=${RANDOM_GT_MASK_NON_GT}"
...
python3 -m verl.trainer.main_ppo \
    ...
    unsupervised_reward.random_gt_top_pct=$RANDOM_GT_TOP_PCT \
    unsupervised_reward.random_gt_mask_non_gt=$RANDOM_GT_MASK_NON_GT \
