...
export DATA_DIR=xxx
export REWARD_TYPE=grpo_adv_diff_top_gt
export ORACLE_GT_TOP_PCT=${ORACLE_GT_TOP_PCT:-0.2}
export GRPO_ADV_TOP_PCT=${GRPO_ADV_TOP_PCT:-$ORACLE_GT_TOP_PCT}
export SOFT_ADV=${SOFT_ADV:-100.0}
export TENSORBOARD_DIR="xxx/al-rlvr/tensorboard_log/train_log/phi_oracle_adv${ORACLE_GT_TOP_PCT}_softadv_${SOFT_ADV}"
...
export EXPERIMENT_NAME=${REWARD_TYPE}-top_${GRPO_ADV_TOP_PCT}-softadv_${SOFT_ADV}-phi

# ROLLOUT_DIR=xxx/al-rlvr/logs/4b_oracle_adv${ORACLE_GT_TOP_PCT}_softadv_${SOFT_ADV}
...
export ACTOR_MODEL_PATH=xxx/llm_model/Phi-4-mini-instruct
...
echo "[top_pct] ORACLE_GT_TOP_PCT=${ORACLE_GT_TOP_PCT}, GRPO_ADV_TOP_PCT=${GRPO_ADV_TOP_PCT}"
...
python3 -m verl.trainer.main_ppo \
    ...
    unsupervised_reward.random_gt_top_pct=$GRPO_ADV_TOP_PCT \
