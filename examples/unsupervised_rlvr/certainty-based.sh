...
export TENSORBOARD_DIR="xxx/al-rlvr/tensorboard_log/train_log/4b_certainty"
...
export EXPERIMENT_NAME=${REWARD_TYPE}-4b

ROLLOUT_DIR=xxx/al-rlvr/logs/4b_certainty
...
export ACTOR_MODEL_PATH=xxx/llm_model/Qwen3-4B
