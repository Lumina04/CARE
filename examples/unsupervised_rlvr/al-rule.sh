...
export REWARD_FUNCTION_PATH=${REWARD_FUNCTION_PATH:-$PROJECT_ROOT/verl/utils/reward_score/ttrl_math/__init__.py}
...
export TENSORBOARD_DIR="xxx/al-rlvr/tensorboard_log/train_log/phi_care_p_${PROBE_GT_TOP_PCT}_p2_${PROBE_PROB_GATE}-onpolicy"
...
export EXPERIMENT_NAME=care-p_${PROBE_GT_TOP_PCT}_p2_${PROBE_PROB_GATE}-phi-onpolicy
