...
export DATA_DIR=xxx
export TENSORBOARD_DIR="xxx/al-rlvr/tensorboard_log/train_log/1.7b_ttrl"
...
export ZERO_WRONG_MAJORITY_ADV=${ZERO_WRONG_MAJORITY_ADV:-False}

export EXPERIMENT_NAME=${REWARD_TYPE}-1.7b

# ROLLOUT_DIR=xxx/al-rlvr/logs/1.7b_ttrl
