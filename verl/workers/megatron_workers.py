...
class ActorRolloutRefWorker(MegatronWorker, DistProfilerExtension):
    ...
    @register(dispatch_mode=Dispatch.MEGATRON_COMPUTE_PROTO)
    @DistProfiler.annotate(color="blue")
    def compute_prompt_last_hidden(self, data: DataProto):
        raise NotImplementedError(
            "unsupervised_reward.estimator=grpo_adv_diff_probe_setscorer currently supports fsdp actor strategy only"
        )
